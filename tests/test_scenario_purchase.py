...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        self.assertEqual(purchase_line2.unit_price, Decimal(5))
        ...
        self.assertEqual(purchase_line3.unit_price, Decimal(5))
        ...
        self.assertEqual(purchase_line4.unit_price, Decimal(30))
        ...
        purchase_line1.product = product
        purchase_line1.quantity = 1.0
        self.assertEqual(purchase_line1.unit_price, Decimal(20))
